...
class AnsibleBackend(BaseBackend):
    ...
    def execute_backend(self):
        ...
        # Fixes issues created to dict parsing
        ...
        with open('/tmp/playbook.yml', 'w') as playbook_outfile:
            playbook_outfile.write(step_yaml)
        ...
        execution_result = execution_result(execution_successful,
                                            ...
                                            playbook_run.stats['failures'])
        # TODO: Change reported output, currently it reports the stdout of
        #       playbook run. This is not user friendly and bugzilla has a
