...
def prepare_bzaf_comment(successful, status, resolution, ci_job_id):
    """
...
def verify_valid_bugs(valid_bugs, verified_status, verified_resolution,
                      bugzilla_instance, job_env, ci_job_id,
    ...
    Parameters:
        ...
        ci_job_id - string(job name + date) identifier
