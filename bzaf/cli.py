                ...
                if 'bzaf' in comment['text']:
                    ...
                    try:
                        ...
                        for step in bzaf_spec['bzaf']['steps']:
                            if not isinstance(bzaf_spec['bzaf']['steps'][step]['rc'],int) and isinstance(bzaf_spec['bzaf']['steps'][step]['cmd'],str) and isinstance(bzaf_spec['bzaf']['steps'][step]['backend'],str) and isinstance(bzaf_spec['bzaf']['version'],int):
