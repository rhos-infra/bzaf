...
import bugzilla
import bzaf.version
from bzaf.api import spec_validator
import requests
import logging
import colorlog
import sys
    ...
    if bzids:
        ...
        for valid_bug in valid_bugs:
            ...
            for comment in comments[::-1]:
                ...
                bzaf_spec = spec_validator.validate_bzaf_yaml(comment['text']):
                    bzaf_found = True
                    bzaf_spec = comment['text']
                    break
                else:
            ...
            if bzaf_found:
                ...
                logger.error("Failed to locate valid bzaf spec")
            # if bzaf_found:
            #     # Execute valid specs
